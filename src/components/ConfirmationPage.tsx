...
interface ConfirmationPageProps {
  onAction: (action: 'dashboard' | 'home' | 'profile') => void;
              ...
              {registrationData?.role === 'consumer' ? (
                <>
                  ...
                  <button
                    ...
                    className="group flex-1 bg-gradient-to-r from-gray-500 to-gray-600 text-white px-8 py-4 rounded-xl hover:from-gray-600 hover:to-gray-700 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl flex items-center justify-center"
                  >
                    <Home className="mr-3 w-6 h-6 group-hover:scale-110 transition-transform" />
                    Go to Home
                  </button>
                </>
              ) : (
                <>
                  ...
                  >
                    <Star className="mr-3 w-6 h-6 group-hover:scale-110 transition-transform" />
                    Your Profile
                  </button>
                </>
              )}
